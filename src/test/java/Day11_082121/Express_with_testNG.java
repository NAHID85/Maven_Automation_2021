...
public class Express_with_testNG {
    ...
    @Test
    public void ExpressCheckoutIteration() throws InterruptedException, WriteException, WriteException {
        for (int i = 1; i < 2; i++) {
            ...
            Reusable_Methods.mouseHover(driver, "//a[text()='Men']", 0,"Mens tab");
            Thread.sleep(2500);
            //click on polo link
            Reusable_Methods.clickMethod(driver, "//a[text()='Polos']", "POLOS");
            Thread.sleep(2500);
            //click on first polo
